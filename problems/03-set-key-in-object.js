...
let apple = {color: 'red'}
console.log(setKeyInObject(apple, "candy", "yum"))

//my first attempt
function setKeyInObject2(obj, string, value) {
  // Your code here//
  let strr = string + ':';
  let atg= JSON.stringify(obj) + strr + value
  alltg = '{' + atg + '}'
  console.log(alltg);
...
setKeyInObject2(tree, "candy", "yum")
